  ...
  return (
    <div className="min-h-screen bg-[#F2F1F0] text-[#063C6B] selection:bg-[#F07A20] selection:text-white">
      <div className="relative overflow-hidden">
        ...
        {/* Crest orbs */}
        <div className="orb-1 pointer-events-none absolute right-[-8rem] top-24 h-[32rem] w-[32rem] rounded-[42%] border border-[#063C6B]/12 bg-[#6FA3C2]/14 blur-[1px]" />
        <div className="orb-2 pointer-events-none absolute right-[2rem] top-16 h-[22rem] w-[22rem] rounded-[45%] border border-[#063C6B]/10 bg-white/30" />
